...
class Figuras extends THREE.Object3D {
  ...
  createTaza(){
    ...
    taza.translateOnAxis(new THREE.Vector3(1,0,0),-100);

    return taza;
  }

  createEscuadra(){
    var cuboExterno = new THREE.BoxGeometry(20,20,10);
    var cuboInterno = new THREE.BoxGeometry(20,20,10);
    var hueco = new THREE.BoxGeometry(4,4,10);
    var curva = new THREE.CylinderGeometry(4,4,10,8);
    ...
    cilArriba.translate(-8,5,0);
    cilAbajo.translate(3.5,-9,0);
  ...
  createTuerca(){
    ...
    var ondulaciones = new THREE.CylinderGeometry(6.5,6.5,1,40);
    ...
    tuerca.translateOnAxis(new THREE.Vector3(1,0,0),100);
